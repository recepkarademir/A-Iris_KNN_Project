...
void testVeriFonk(int egitimSeti,int dogrulamaSeti,int testSeti , float veriSeti[][5],int veriNitelik,float tahminYuzde,bool shuffle_testi, int kEgitim)
{
	...
	*/
	...
	cout<<"Aþaðýdaki yüzdelik deðeri en yüksek olan iris adý tahmin olacaktýr.\n";
	...
	if(tahminYuzde==-1.0)
	{
		cout<<"Programýn öngörülen tahmin doðruluk oraný bilinmiyor !"<<endl;
	}
	else
	{
		cout<<"Programýn öngörülen tahmin doðruluk oraný  k = "<<kEgitim<<" için  % "<<tahminYuzde<<endl;
	}
